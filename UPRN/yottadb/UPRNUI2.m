...
PROCESS(file,user,ZCOGID) ;
 ...
 .set BLPUSTAT=$GET(B("BestMatch","LogicalStatus"))
 ...
 .I $D(^BUSER("USER",user))!($GET(ZCOGID)'="") D ROW^UPRNUI3(user,file,ZID,UPRN,ADDFORMAT,ALG,CLASS,MATCHB,MATCHF,MATCHN,MATCHP,MATCHS,ABPN,ABPP,ABPS,ABPT,QUAL,adrec,ABPB,CTERM,ABPF,BLPUSTAT)
 .S cnt=cnt+1
