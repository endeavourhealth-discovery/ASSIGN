...
STT ;
 ...
 s cmd="curl -H ""Accept: application/vnd.github.v3+json"" -o /tmp/dev/git.json https://api.github.com/repos/endeavourhealth-discovery/ASSIGN/contents/UPRN/yottadb"
 zsystem cmd
 s f="/tmp/dev/git.json"
