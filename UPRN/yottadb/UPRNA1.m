...
f156 ;
 ...
 .I '$D(^UPRNX("X.3",ZONE,adbuild)) d
 ..I $D(^UPRNX("X.3",ZONE,$p(adbuild," ",1,$l(adbuild," ")-1))) d
 ...
 i adflat="",adbuild'="",'$D(^UPRNX("X.3",ZONE,adbuild)) d
 ...
 .I $g(^UPRNX("X.STR",ZONE,adstreet))?1l.e d
 ..s adstreet=^(adstreet)
