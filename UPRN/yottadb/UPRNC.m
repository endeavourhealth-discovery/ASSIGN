...
match73(tpost,tstreet,tbno,tbuild,tflat,tloc,tdeploc) 
	;No match on street or number but exact on flat building and post code
	i tstreet=""!(tbuild="")!(tflat="") q ""
	s matched=0
	s matchrec="Pe"
	s uprn=""
	...
	. . . . s $p(ALG,"-",2)="match73b"
	. . . . s matched=$$set^UPRN(uprn,table,key)
	. . . i build=tbuild,flat=tflat,bno'=tbno,street'=tstreet d  q:matched
