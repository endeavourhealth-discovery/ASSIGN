UPRN1A ;Import routine [ 06/10/2019  4:58 PM ] ; 8/1/23 10:51am
 ; YOTTADB version!
 ;
 d files
SURE ;
...
ds7 .s ukey="U"
 ...
 .i change="d" k ^UPRN(ukey,uprn,"D",key) quit
 .set org=$p(rec,del,6)
 .set dep=$p(rec,del,7)
 .s flat=$p(rec,del,8)
...
ds20 .s ukey="U"
 .s key=$p(rec,del,5)
 .i change="d" k ^UPRN(ukey,uprn,"L",key) quit
...
IMPBLP ;
 ...
 .i change="d" do  quit
 ..k ^UPRN(ukey,uprn)
 ..i parent'="" k ^UPRN("UPC",parent,uprn)
 ..quit
