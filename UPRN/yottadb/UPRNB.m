UPRNB ;Best fit algorithms for UPRN match [ 08/07/2023  9:00 AM ]
	;
...
farpost ;No post code match
	...
	i $D(^UPRNX("X3",ZONE,tstreet,tbno)) d
	. s post=""
	...
	. . i tloc'="",tbuild="",$D(^UPRNX("X5",post,tstreet,tbno,tloc,tflat)) d  q
	. . . s matchrec="Pp,Se,Ne,Be,Fe"
	. . . s ^TBEST($J,matchrec,tbno,tloc,tflat)=""
	. . . s ^TBEST($J,matchrec)=post
	. . i tbuild'="",tflat'="",tbno'="" d  q
	...
	I $D(^TBEST($J)) q
	i tflat'="",tbuild'="" d
	. I $D(^UPRNX("X3",ZONE,tstreet)) d
	. . s bno=""
	. . for  s bno=$O(^UPRNX("X3",ZONE,tstreet,bno)) q:bno=""  d
	. . . s post=""
	. . . for  s post=$O(^UPRNX("X3",ZONE,tstreet,bno,post)) q:post=""  d
	. . . . i post=tpost q
	. . . . s build=""
...
bestfit1        ;
	...
	I '$D(^UPRNX("X3",ZONE,tbuild,tflat,tpost)),'$d(^UPRNX("X3",ZONE,build,tflat,tpost)) q
...
bestch ;Fits with a care home
	...
	. . . . s matched=$$setuprns(matchrec,"X5",tpost,tstreet,tbno,build,tflat)
	q
	;	
	;	
bestfitn          ;Fits with no building
	...
	. S post=""
	. for  s post=$O(^UPRNX("X3",ZONE,tbuild,tflat,post)) q:post=""  d
	. . q:post=tpost
	. . s np=$$nearpost^UPRN(post,tpost,1)
	. . i np="Pl" d
	. . . I $D(^UPRNX("X3",ZONE,post,tstreet,tbno,tbuild,tflat)) d
