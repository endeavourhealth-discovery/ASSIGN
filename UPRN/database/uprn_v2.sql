...
CREATE TABLE `uprn_main` (
  ...
  `bno` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `build` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `flat` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `street` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `name` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `locaility` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `admin` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `town` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `deploc` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `loc` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `org` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
